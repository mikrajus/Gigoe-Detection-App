    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDetailRow("NIK", patient['nik']?.toString() ?? '-'),
          _buildDetailRow("Nama Lengkap", patient['nama']?.toString() ?? '-'),
          _buildDetailRow("Tanggal Lahir", patient['ttl']?.toString() ?? '-'),
          _buildDetailRow("Jenis Kelamin", patient['gender']?.toString() ?? '-'),
          ...
          const Divider(height: 20, thickness: 1),
          _buildDetailRow("Tanggal", patient['tanggal_pemeriksaan']?.toString() ?? '-'),
